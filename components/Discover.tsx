...
const Discover = () => {
  ...
  const actveTopicStyle = 'xl:border-2 hover:bg-primary xl:border-[#F51997] px-3 py-2 rounded xl:rounded-full flex items-center gap-2 justify-center cursor-pointer text-[#F51997]';
      ...
      <div className='flex gap-3 flex-wrap'>
        {topics.map((item) => (
          <Link 
            ...
            key={item.name}
          >
            <div className={topic === item.name ? actveTopicStyle : topicStyle}>
